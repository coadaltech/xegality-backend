...
type InsertApplicationType = Omit<
  InferInsertModel<typeof application_model>,
  "updated_at"
>;
type UpdateApplicationType = Partial<InsertApplicationType>;
type ApplicationTypeWithOptionalConsumer = Omit<
