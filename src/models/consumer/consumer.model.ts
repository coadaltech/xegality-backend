...
import { pgTable, bigint, integer, varchar, text } from "drizzle-orm/pg-core";
import { user_model } from "../shared/user.model";
import { GENDER_CONST, MARITAL_STATUS_CONST } from "../../types/user.types";
...
type ConsumerWithUserType = ConsumerType &
  Omit<
